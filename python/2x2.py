...
axes[0, 0].set_title("Expectation Value E")
...
axes[1, 1].set_title(r"Expectation Value $M^2$")
...
axes[0, 2].set_title(r"$C_V$ [$k_B$]", fontsize=14)
...
axes[1, 2].set_title(r"$\chi$ $[1/J]$", fontsize=14)
...
axes[1, 0].set_ylabel(rf"$ E^2 [J]$")
axes[0, 1].set_ylabel(r"$\langle |M| \rangle $")
axes[1, 1].set_ylabel(r"$M|^2$")
axes[0, 2].set_ylabel(r"$C_V$ [$k_B$]")
axes[1, 2].set_ylabel(r"$\chi$ [$1/J$]")
for ax in axes.flat:
    ax.legend()
...
axes[1, 2].set_title(r"$\chi$ $[J^{-1}]$", fontsize=14)
axes[1, 2].legend()
axes[0, 0].set_xlabel(r"Temperature T $[J/k_B]$")
axes[1, 0].set_xlabel(r"Temperature T $[J/k_B]$")
axes[0, 1].set_xlabel(r"Temperature T $[J/k_B]$")
...
while number <=4:
    for b in cycle_:
        ...
        number+=1
axes[0].set_title("Expectation Value E")
axes[1].set_title("Expectation Value M")
axes[2].set_title(r"$C_V$ [$k_B$]", fontsize=14)
